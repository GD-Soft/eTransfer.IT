    ...
    if (response.status_code == "+Ok") {
        var partners = eval(response.obj);
            ...
            for (var partner in partners) {
                ...
                var xpcontrol = "<span class='outerprogress'><span class='innerprogress' style='width:" + width + "% !important; background:url(xp.png) repeat-x;'><span class='progressval'>" + partners[partner].etransfer_xpscore + "/" + partners[partner].etransfer_max_xpscore.replace(",00", "") + "  xp</span></span></span>";
